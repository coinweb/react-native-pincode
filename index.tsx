    ...
    renderLockedPage = () => {
        return (
            <ApplicationLocked
                ...
                textDescription={
                    this.props.textDescriptionLockedPage || undefined
                }
                textSubDescription={
                ...
                titleComponent={
                    this.props.titleComponentLockedPage || undefined
                }
            />
        );
    };
            ...
            <View style={[styles.container, styleMainContainer]}>
                {status === PinStatus.choose && (
                    <PinCodeChoose
                        ...
                        styleCircleSizeFull={
                            this.props.stylePinCodeHiddenPasswordSizeFull
                        }
                        styleColorButtonTitle={
                            this.props.stylePinCodeButtonNumber
                        }
                        styleColorButtonTitleSelected={
                            this.props.stylePinCodeButtonNumberPressed
                        }
                        styleColorSubtitle={
                            this.props.stylePinCodeColorSubtitle
                        }
                        styleColorSubtitleError={
                            this.props.stylePinCodeColorSubtitleError
                        }
                        styleColorTitle={this.props.stylePinCodeColorTitle}
                        styleColorTitleError={
                            this.props.stylePinCodeColorTitleError
                        }
                        styleColumnButtons={
                            this.props.stylePinCodeColumnButtons
                        }
                        styleColumnDeleteButton={
                            this.props.stylePinCodeColumnDeleteButton
                        }
                        styleContainer={this.props.stylePinCodeChooseContainer}
                        styleContainerPinCode={
                            this.props.stylePinCodeMainContainer
                        }
                        ...
                        styleDeleteButtonIcon={
                            this.props.stylePinCodeDeleteButtonIcon
                        }
                        styleDeleteButtonSize={
                            this.props.stylePinCodeDeleteButtonSize
                        }
                        styleDeleteButtonText={
                            this.props.stylePinCodeDeleteButtonText
                        }
                        ...
                        styleTextButton={
                            this.props.stylePinCodeTextButtonCircle
                        }
                        ...
                        textPasswordVisibleSize={
                            this.props.textPasswordVisibleSize
                        }
                        titleAttemptFailed={this.props.titleAttemptFailed}
                        titleChoose={
                            this.props.titleChoose || "1 - Enter a PIN Code"
                        }
                ...
                {status === PinStatus.enter &&
                    !isLocked && (
                        <PinCodeEnter
                            ...
                            callbackErrorTouchId={
                                this.props.callbackErrorTouchId
                            }
                            ...
                            getCurrentLength={this.props.getCurrentPinLength}
                            handleResult={
                                this.props.handleResultEnterPin || null
                            }
                            iconButtonDeleteDisabled={
                                this.props.iconButtonDeleteDisabled
                            }
                            ...
                            pinCodeVisible={this.props.pinCodeVisible}
                            pinStatusExternal={
                                this.props.pinStatus || PinResultStatus.initial
                            }
                            status={PinStatus.enter}
                            storedPin={this.props.storedPin || null}
                            styleAlphabet={this.props.styleAlphabet}
                            styleButtonCircle={
                                this.props.stylePinCodeButtonCircle
                            }
                            styleCircleHiddenPassword={
                                this.props.stylePinCodeHiddenPasswordCircle
                            }
                            ...
                            styleContainer={
                                this.props.stylePinCodeEnterContainer
                            }
                            styleContainerPinCode={
                                this.props.stylePinCodeMainContainer
                            }
                            ...
                            styleEmptyColumn={
                                this.props.stylePinCodeEmptyColumn
                            }
                            stylePinCodeCircle={this.props.stylePinCodeCircle}
                            styleRowButtons={this.props.stylePinCodeRowButtons}
                            styleTextButton={
                            ...
                            styleTextSubtitle={
                                this.props.stylePinCodeTextSubtitle
                            }
                            styleTextTitle={this.props.stylePinCodeTextTitle}
                            styleViewTitle={this.props.stylePinCodeViewTitle}
                            ...
                            textCancelButtonTouchID={
                                this.props.textCancelButtonTouchID
                            }
                            textPasswordVisibleFamily={
                                this.props.textPasswordVisibleFamily
                            }
                            ...
                            title={
                                this.props.titleEnter || "Enter your PIN Code"
                            }
                            titleAttemptFailed={this.props.titleAttemptFailed}
                            titleComponent={this.props.titleComponent}
                            titleConfirmFailed={this.props.titleConfirmFailed}
                            ...
                            touchIDTitle={
                                this.props.touchIDTitle || touchIDTitleDefault
                            }
                            vibrationEnabled={this.props.vibrationEnabled}
