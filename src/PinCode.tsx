            ...
            >
                {({ opacity }: any) => (
                    <TouchableHighlight
                        ...
                        disabled={disabled}
                        onShowUnderlay={() =>
                            this.setState({ textButtonSelected: text })
                        }
                        onHideUnderlay={() =>
                            this.setState({ textButtonSelected: "" })
                        }
                        onPress={() => {
        ...
        return (
            ...
            >
                {_.range(this.props.passwordLength).map((val: number) => {
                    const lengthSup =
                        ((password.length >= val + 1 && !changeScreen) ||
                            showError) &&
                        !attemptFailed;
                    return (
                        <Animate
                                        ...
                                        ? this.props.buttonDeleteComponent(
                                              () => {
                                                  if (
                                                      ...
                                                      const newPass = this.state.password.slice(
                                                          0,
                                                          -1
                                                      );
                                                      this.setState({
