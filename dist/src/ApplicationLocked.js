...
class ApplicationLocked extends React.PureComponent {
    constructor(props) {
        ...
        this.renderIcon = () => {
            return (React.createElement(react_native_1.View, { style: [styles.viewIcon, this.props.styleViewIcon] }, this.props.lockedIconComponent ? (this.props.lockedIconComponent) : (React.createElement(Icon, { name: this.props.nameIcon, size: this.props.sizeIcon, color: this.props.colorIcon }))));
        };
    ...
    async timer() {
        ...
        if (timeDiff < 1000) {
            ...
            async_storage_1.default.multiRemove([this.props.timePinLockedAsyncStorageName, this.props.pinAttemptsAsyncStorageName]);
        }
        if (!this.isUnmounted) {
            this.timer();
        }
