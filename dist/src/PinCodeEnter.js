...
class PinCodeEnter extends React.PureComponent {
    constructor(props) {
        ...
        this.endProcess = async (pinCode) => {
            if (!!this.props.endProcessFunction) {
                ...
                if (pinValidOverride !== undefined ? pinValidOverride : pin === pinCode) {
                    ...
                    async_storage_1.default.multiRemove([this.props.pinAttemptsAsyncStorageName, this.props.timePinLockedAsyncStorageName]);
        ...
        if (!this.props.storedPin) {
            react_native_keychain_1.default.getInternetCredentials(this.props.pinCodeKeychainName, utils_1.noBiometricsConfig)
                .then((result) => {
